...
* Tue Jul 07 2026 Alex Kirhenshtein <alk@netxms.org> - 6.2.1-1
  ...
  * Fixed authenticated denial-of-service issues in web API (self password change) and NXCP (CMD\_RESOLVE\_DCI\_NAMES)
  * Fixed issues:
...
* Mon Jun 29 2026 Alex Kirhenshtein <alk@netxms.org> - 6.2.0-1
  ...
  *   #3287 (Interfaces show as [0] in FDB tab of Fortiswitch)
